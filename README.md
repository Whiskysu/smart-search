...
- 📣 Surface-level narratives without questioning _who benefits_ from the framing
...
`smart-search` is a **strategy layer** that activates before Claude answers any research question. It doesn't add new tools — it changes _how Claude thinks_ about searching.
...
| Accepts the dominant narrative      | Asks: _who benefits from this framing? what's being omitted?_  |
...
**4. Interest-layer analysis** — For geopolitical and economic topics, Claude is instructed to probe: _Who is saying this? Who benefits? What is being omitted? Are there historical parallels?_ Most AI tools answer the surface question. This skill makes Claude answer the deeper one.
...
git clone https://github.com/Whiskysu/smart-search ~/.claude/skills/smart-search
